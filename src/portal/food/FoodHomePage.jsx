  ...
  return (
    ...
    >
      <motion.div
        ...
        className="mb-5 rounded-3xl border border-brand-border bg-white p-4 shadow-sm overflow-hidden relative"
      >
        ...
        <h2 className="font-black text-brand-black text-xl tracking-tight">
        ...
        {(data?.cuisines || []).length > 0 && (
          <div className="flex gap-2 overflow-x-auto pt-3 pb-0.5 [scrollbar-width:none] [&::-webkit-scrollbar]:hidden">
            <button
              type="button"
              onClick={() => setCuisine("")}
              className={`shrink-0 px-4 py-2 rounded-full text-xs font-black border whitespace-nowrap transition-colors ${
                !cuisine
